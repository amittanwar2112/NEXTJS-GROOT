...
const settings = [
  {key:'ForgotIRCTCPassword', serviceName: 'Forgot IRCTC Password ', className: styles.trainRunningStatus, url: 'https://www.goibibo.com/trains/irctc-forgot-password/'},
  {key:'ForgotIRCTCId', serviceName: 'Forgot IRCTC ID', url: 'https://www.goibibo.com/trains/irctc-forgot-userid/'},
  {key:'CreateIRCTCId', serviceName: 'Create IRCTC ID  ', className: styles.trainCoach, url: 'https://www.goibibo.com/trains/create-irctc-account/'},
];
      ...
      <div  className={`${styles.smallCardsWrap}`} >
        {
          settings.map((setting,index) => {
            ...
            return (
              <aside key={index} className={`${styles.smallCards} padLR10 curPoint`} onClick={() => {openInNewTab(url, key)}}>
