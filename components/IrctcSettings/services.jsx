...
const services = [
  {
    key: 'home',
    serviceName: 'Book Train',
    className: styles.trainDetails,
    url: 'https://www.goibibo.com/trains/'
  },
  {
    key: 'pnr',
    serviceName: 'PNR Status',
    className: styles.checkPnr,
    url: 'https://www.goibibo.com/trains/check-pnr-status/'
  },
  {
    key: 'lts',
    serviceName: 'Live train status',
    className: styles.trainRunningStatus,
    url: 'https://www.goibibo.com/trains/check-train-running-status/'
  },
  {
    key: 'coach',
    serviceName: 'View train coach position ',
    className: styles.trainCoach,
    url: 'https://www.goibibo.com/trains/train-coach-position/'
  },
  {
    key: 'pl',
    serviceName: 'Platform Locator',
    src: 'https://gos3.ibcdn.com/PlatformLocator-1609134539.png',
    url: 'https://www.goibibo.com/trains/platform-locator',
    sprite: false
  }
];
...
const InformationServices = ({ currentPage = '', currentPageGa = '' }) => {
  ...
  return (
    <section className="marginTB20">
      <h2 className={`${styles.titleHeader} ${styles.titleHeaderh2}`}>
            ...
            <aside
              ...
              <div className={`${styles.flex} ${styles.row} ${styles.alignCenter} width90`}>
                <span className={`${styles.padR10}`}>
                  {sprite ? (
                    <span className={`${styles.trainsServicesSprite} + ${className} `}></span>
                  ) : (
                    comp(src)
                  )}
                </span>
