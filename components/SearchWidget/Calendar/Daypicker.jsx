...
const Daypicker = ({
  ...
  const changeMonth = (nextMonth) => {
    const shouldNotChangeMonth =
      (nextMonth === -1 && monthSelected === currentMonth) ||
      (nextMonth === 1 && monthSelected === lastMonth);
