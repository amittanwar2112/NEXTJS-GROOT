...
export function parseUrlIntoTrainsParams(urlQuery, track = '') {
  ...
  export function parseParamsToUrl(data) {
    const { source = {}, destination = {}, departure_date = {}, train = {}, availability = {}} = data || {};
  ...
  export function getTrainsParams(store) {
    const { source = {}, destination = {}, departure_date = {}, train =  {}, class:travelClassObj = {}, availability = {}} = store;
  ...
  export function availLocalCache(storeVal) {
    ...
    function updateCurrentStoreContent(key) {
      ...
      cachedReviewDetails[key] = currentStoreVal[key] ? currentStoreVal[key]: (cachedReviewDetails[key] || '');
    }
    ...
    if(cachedValAddress || cachedValPinCode) {
      ...
      currentStoreVal.tktAddress.address = currentStoreVal.tktAddress && Object.keys(currentStoreVal.tktAddress).length && currentStoreVal.tktAddress.address ? currentStoreVal.tktAddress.address : cachedValAddress;
      currentStoreVal.tktAddress.pinCode = currentStoreVal.tktAddress && Object.keys(currentStoreVal.tktAddress).length && currentStoreVal.tktAddress.pinCode ? currentStoreVal.tktAddress.pinCode : cachedValPinCode;
    }
