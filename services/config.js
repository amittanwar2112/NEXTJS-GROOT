...
export const FOOTER_DATA_URL =
  'https://pageroverprodpp.goibibo.com/gt_rail/api/v1/get_footer_links/';
...
export const SEO_META_DATA = {
  pnr_status_json: {
    seo_meta: {
      ...
      meta_description:
        'Check Indian Railways PNR status. Simply enter your 10 digit PNR number and get accurate train ticket status with coach and seat number.',
      meta_keywords:
        'PNR Status, PNR Enquiry, Indian Railway PNR Status, PNR number, PNR Prediction, Live PNR status',
  ...
  train_running_status_json: {
    seo_meta: {
      ...
      meta_description:
        'Get live train status at one click from Goibibo. Spot your train with exact location, real time delay and estimated time of arrival.  Train enquiry with exact train status.',
      meta_keywords:
        'Live Train Status, Spot Your Train, Live Train Status, live train status, real time delay, Train enquiry, train status',
  ...
  irctc_forgot_password_json: {
    seo_meta: {
      ...
      meta_description:
        'Reset your password for IRCTC Account, in case you have forgot password. Goibibo offers IRCTC forgot password feature in quick & easy steps. Just enter your login id and mobile number to change the password of your IRCTC login ID.',
  ...
  irctc_forgot_userid_json: {
    seo_meta: {
      ...
      meta_description:
        'Follow the simple steps to recover Forgot IRCTC user ID. Find details of IRCTC user ID recovery from mobile number or Email ID.',
  ...
  irctc_create_new_user_json: {
    seo_meta: {
      ...
      meta_description:
        'Create IRCTC login account. Goibibo offers quick and easy way to do IRCTC registration. Create IRCTC login User ID by providing relevant information. Find all info about IRCTC signup process on Goibibo.',
      meta_keywords:
        'irctc login, irctc login id, irctc registration, irctc login new, irctc sign up',
  ...
  train_home_page_content: {
    seo_meta: {
      ...
      meta_description:
        'Book Indian Railways tickets online on Goibibo. Get confirmed IRCTC Train Ticket, Book Tatkal tickets and get PNR Status updates powered by IRCTC. Check Train Schedule and Seat availability using IRCTC login.',
      meta_keywords:
        'Book Train tickets, Book IRCTC Train tickets online, Book Train tickets online, IRCTC Train Ticket Booking, Train Tickets from  to  , IRCTC Trains to , Indian Railways from , Train ticket Booking, IRCTC Ticket Booking, IRCTC Train tickets, train enquiry, Indian Railways Reservation',
